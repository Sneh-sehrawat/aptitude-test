    ...
    <div className='container1'>
      ...
      <div style={{ maxWidth: 400 }} className='signup-container'>
        ...
        <form onSubmit={handleSubmit} className='signup-form'>
          ...
          <input type="text" placeholder="Phonenumber" value={phoneno} onChange={e => setPhoneno(e.target.value.replace(/\D/g, ''))} maxLength={10} required />
          <input type="text" placeholder="Company(optional)" value={company} onChange={e => setCompany(e.target.value)} />

          <p style={{ textAlign: "center", marginTop: "1rem" }}>
            Already have an account?{" "}
            <a href="/login" style={{ color: "#16a34a", fontWeight: "bold" }}>Sign In</a>
          </p>
